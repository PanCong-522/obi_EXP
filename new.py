...
C_model = three_exp_model(t, N_res, L_res, M_res, ka_res, alpha_res, beta_res)
C_fit = three_exp_model(t_fit, N_res, L_res, M_res, ka_res, alpha_res, beta_res)
...
# -------------------- AUC 与模型评价指标 --------------------
AUC_model = N_res / ka_res + L_res / alpha_res + M_res / beta_res
...
# -------------------- 推导药动学参数 --------------------
numerator = L_res * beta_res * (ka_res - alpha_res) + M_res * alpha_res * (ka_res - beta_res)
denominator = L_res * (ka_res - alpha_res) + M_res * (ka_res - beta_res)
K21 = numerator / denominator
K10 = (alpha_res * beta_res) / K21
K12 = alpha_res + beta_res - K21 - K10

t_half_a = 0.693 / ka_res
t_half_alpha = 0.693 / alpha_res
t_half_beta = 0.693 / beta_res
